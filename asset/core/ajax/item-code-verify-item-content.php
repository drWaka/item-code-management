  ...
  if (isset($_POST['itemDesc']) && isset($_POST['itemRecId'])) {
    ...
    if ($itemDesc -> valid == 1 && $itemRecId -> valid == 1) {
      ...
      $transactQry = '
        ...
        INNER JOIN status as e ON b.FK_verify_stat = e.PK_status
          ...
          $content['recContent'][] = '
            <tr>
              ...
              <td>
                ...
                <button class="btn btn-success transaction-btn" data-link="../asset/core/ajax/item-code-verify-item-select.php" data-target="modal-container" data-content="{
                    &quot;recordId&quot; : &quot;' . $recRow['PK_item_code'] . '&quot;,
                    &quot;itemRecId&quot; : &quot;' . $recRow['FK_item_code_req'] . '&quot;
                  }" trans-name="modal-rec" title="Mark as Existing" ' . $hidden . '><i class="fas fa-check"></i></button>
              </td>
            </tr>
          ';
        }
