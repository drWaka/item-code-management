  ...
  if (isset($_POST['recordId'])) {
    ...
    if ($recordId -> valid == 1) {
      $content['modal'] = modalize(
        '<div class="row">
          <div class="col-sm-12">
            <h2 class="header capitalize text-center">Item Code Request Details</h2>
          </div>
          ...
          <div class="col-sm-12">            
            <div class="row">
              ...
              <div class="form-group col-sm-12">
                <input name="risNo" class="form-control" placeholder="RIS No" value="' . $recordRow['ris_no'] . '" readonly>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-12">
                <textarea name="deptAccess" class="form-control" placeholder="Requesting Department(s)" readonly>' . $recordRow['dept_access'] . '</textarea>
              </div>
            </div>
