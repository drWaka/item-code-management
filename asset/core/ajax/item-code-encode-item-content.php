<?php 
  ...
  if (isset($_POST['itemDesc']) && isset($_POST['itemRecId'])) {
    ...
    if ($itemDesc -> valid == 1 && $itemRecId -> valid == 1) {
      ...
      $transactQry = '
        SELECT a.item_code as item_code, a.item_desc as item_desc, c.item_categ_desc as item_categ, d.item_group_desc as item_group, a.isExisting as isExisting, a.PK_item_code as PK_item_code, a.FK_item_code_req as FK_item_code_req
          ...
          $content['recContent'][] = '
            <tr>
              ...
              <td>
                ...
                <button class="btn btn-success transaction-btn ' . $hideEncodeBtn . '" data-link="../asset/core/ajax/item-code-encode-item-select.php" data-target="modal-container" data-content="{
                    &quot;recordId&quot; : &quot;' . $recRow['PK_item_code'] . '&quot;,
                    &quot;itemRecId&quot; : &quot;' . $recRow['FK_item_code_req'] . '&quot;
                  }" trans-name="modal-rec" title="Encode Item" ' . $hidden . '><i class="fas fa-check"></i></button>
              </td>
            </tr>
          ';
        }
