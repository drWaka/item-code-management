  ...
  <body>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-8">
                <div class="row">
                  <div class="col-2">
                    <a href="item-code-encode.php"><button class="btn btn-info"><i class="fa fa-chevron-left"></i><i class="fa fa-chevron-left"></i> Back</button></a>
                  </div>
                </div>
              </div>
              <div class="col-4">
    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        send_request_asycn (
          '../asset/core/ajax/item-code-encode-item-content.php', 
          'POST', 
          {
            itemDesc : '',
            itemRecId : itemRecId
