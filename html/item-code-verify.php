<?php 
  ...
  if (!($_SESSION['userType'] == 'verifier' || $_SESSION['userType'] == 'administrator')) {
  ...
  <body>
            ...
            <div class="row advFilter hide">
              ...
              <div class="col-6 margin-top-xs">
                <div class="row">
                  ...
                  <div class="col-3">
                    <label for="statPending"><input type="checkbox" name="verifStat[]" value="pending" id="statPending" class="" checked disabled> Pending</label>
                  </div>
                  <div class="col-3">
                    <label for="statVerified"><input type="checkbox" name="verifStat[]" value="verified" id="statVerified" class="" checked> Verified</label>
                  </div>
                </div>
              </div>
    ...
    <script>
      ...
      function refreshList() {
        let statChkBox = document.querySelectorAll("[name='verifStat[]']:checked");
        var checkedStatBox = '';
        ...
        send_request_asycn (
          '../asset/core/ajax/item-code-verify-content.php', 
          'POST', 
          {
            risNo : risNo,
      ...
      $(document).ready(function() {
        ...
        $(document).on('click','[name="verifStat[]"]' , function(){
          refreshList();
        });
